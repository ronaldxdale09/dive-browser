...
| `ci/ggml-portable.cmake` | Toolchain file the workflows hand to whisper.cpp so it builds for a fixed Apple Silicon baseline instead of probing the virtualised runner CPU. |
