...
beforeEach(() => {
  useBrowser.setState({
    ...
    open: { sidecar: false, dock: false, palette: false, find: false, settings: false, library: false, shortcuts: false, menu: false, defaultBrowser: false, subtitles: false, tasks: false },
    error: null,
    notice: null,
    recordingTab: null,
  });
