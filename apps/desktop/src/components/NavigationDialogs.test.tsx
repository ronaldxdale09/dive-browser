...
beforeEach(() => {
  ...
  vi.spyOn(ipc, "appInfo").mockResolvedValue({ version: "0.1.0", build: { channel: "dev", number: "1", commit: "abc1234", built_at: 0 }, data_dir: "/tmp/dive", mcp_url: "", mcp_token_path: "", simulate: null, updater: false });
...
describe("foreground navigation dialogs", () => {
  ...
  it("shares the policy across navigation dialogs without resetting panels or drafts", () => {
    const preserved = { sidecar: true, dock: true, find: true, extensions: true, subtitles: true, tasks: false, defaultBrowser: true };
