  ...
  return (
    <AbsoluteFill style={{ background: T.ground, color: T.ink, fontFamily: T.sans, alignItems: "center", justifyContent: "center" }}>
      ...
      <div style={{ position: "relative", display: "flex", flexDirection: "column", alignItems: "center", top: -20 }}>
        ...
        <p style={{ margin: "18px 0 0", fontSize: 17, color: T.ink2, opacity: tag, translate: `0px ${(1 - tag) * 12}px` }}>
      ...
      <div style={{ position: "absolute", bottom: 46, display: "flex", gap: 8 }}>
        {FEATURE_NAMES.map((name, i) => (
          <Reveal key={name} at={56 + i * 3} dx={0} style={{ translate: `0px ${(1 - pop(frame, fps, 56 + i * 3)) * 10}px` }}>
