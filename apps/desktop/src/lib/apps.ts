...
const APPS: AppEntry[] = [
  ...
  { id: "privacy", name: "DivePrivacy", blurb: "Ads and trackers. Off until you turn it on.", category: "yours", command: "settings.privacy", keywords: "tracking blocker ads shield fingerprint" },
