 ...
 *
 * Kept in the app bundle rather than in a test file so the chrome can also
 * evaluate a fragment inside its own document when it needs to — and so the
 * include graph has exactly one reader on this side.
 */
